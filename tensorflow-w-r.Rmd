...
```{r setup, eval = FALSE}
pkgs <- c("keras", "lime", "tidyquant", "tidymodels", "corrr", "tensorflow")
...
churn_data_raw  <- read_csv("https://raw.githubusercontent.com/rstudio/keras-customer-churn/master/data/WA_Fn-UseC_-Telco-Customer-Churn.csv")
